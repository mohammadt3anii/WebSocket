 ...
 */
package test.my.websocket.socket;
...
import static test.my.websocket.socket.WebSocketProtocol.B0_FLAG_FIN;
import static test.my.websocket.socket.WebSocketProtocol.B0_FLAG_RSV1;
import static test.my.websocket.socket.WebSocketProtocol.B0_FLAG_RSV2;
import static test.my.websocket.socket.WebSocketProtocol.B0_FLAG_RSV3;
import static test.my.websocket.socket.WebSocketProtocol.B0_MASK_OPCODE;
import static test.my.websocket.socket.WebSocketProtocol.B1_FLAG_MASK;
import static test.my.websocket.socket.WebSocketProtocol.B1_MASK_LENGTH;
import static test.my.websocket.socket.WebSocketProtocol.OPCODE_BINARY;
import static test.my.websocket.socket.WebSocketProtocol.OPCODE_CONTINUATION;
import static test.my.websocket.socket.WebSocketProtocol.OPCODE_CONTROL_CLOSE;
import static test.my.websocket.socket.WebSocketProtocol.OPCODE_CONTROL_PING;
import static test.my.websocket.socket.WebSocketProtocol.OPCODE_CONTROL_PONG;
import static test.my.websocket.socket.WebSocketProtocol.OPCODE_FLAG_CONTROL;
import static test.my.websocket.socket.WebSocketProtocol.OPCODE_TEXT;
import static test.my.websocket.socket.WebSocketProtocol.PAYLOAD_BYTE_MAX;
import static test.my.websocket.socket.WebSocketProtocol.PAYLOAD_LONG;
import static test.my.websocket.socket.WebSocketProtocol.PAYLOAD_SHORT;
import static test.my.websocket.socket.WebSocketProtocol.toggleMask;
import static test.my.websocket.socket.WebSocketProtocol.validateCloseCode;
